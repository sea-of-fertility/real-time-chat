package com.study.realtimechat.friend.repository;
...
@Repository
public interface FriendInvitationRepository extends ReactiveCrudRepository<FriendInvitationEntity, Long> {
